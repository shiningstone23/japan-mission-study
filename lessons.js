    ...
    questions: [
      {
        ...
        jp: '家族は四人です',
        reading: '카조쿠와 요닌 데스',
        choices: ['家族は四人です', '家族は四つです', '家族が四人います', '家族は四名様です'],
        correct: 0
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: ['私たちのチームは十九人です', 'チームは十九人がいます', '十九人のチームです', 'チームに十九人があります'],
        correct: 0
      },
      {
...
// ══════════════════════════════════════════════
{
  ...
  questions:[
    { q:'"자르다"에 해당하는 일본어는?', jp:'切る', reading:'키루', choices:['切る','混ぜる','煮る','焼く'], correct:0 },
    { q:'"섞다"에 해당하는 일본어는?', jp:'混ぜる', reading:'마제루', choices:['切る','混ぜる','蒸す','炒める'], correct:1 },
    { q:'"끓이다 / 삶다"에 해당하는 일본어는?', jp:'煮る', reading:'니루', choices:['焼く','揚げる','煮る','蒸す'], correct:2 },
    { q:'"굽다"에 해당하는 일본어는?', jp:'焼く', reading:'야쿠', choices:['煮る','蒸す','混ぜる','焼く'], correct:3 },
    { q:'"찌다"에 해당하는 일본어는?', jp:'蒸す', reading:'무스', choices:['蒸す','切る','混ぜる','揚げる'], correct:0 },
    { q:'"볶다"에 해당하는 일본어는?', jp:'炒める', reading:'이타메루', choices:['煮る','焼く','炒める','蒸す'], correct:2 }
  ]
},
{
  ...
  questions:[
    { q:'"조심하세요!"에 해당하는 일본어는?', jp:'気をつけて！', reading:'키오 츠케테', choices:['気をつけて！','どうぞ！','おねがい！','いいよ！'], correct:0 },
    ...
    { q:'"칼 조심하세요!"에 해당하는 일본어는?', jp:'ナイフに気をつけて！', reading:'나이후니 키오 츠케테', choices:['ナイフを使って！','ナイフに気をつけて！','ナイフをください！','ナイフはどこ？'], correct:1 },
    { q:'"화상 조심하세요!"에 해당하는 일본어는?', jp:'やけどに気をつけて！', reading:'야케도니 키오 츠케테', choices:['やけどしてください！','やけどが好き！','やけどに気をつけて！','やけどは大丈夫！'], correct:2 }
  ]
},
{
  ...
  questions:[
    { q:'"잘게 썰어 주세요"에 해당하는 일본어는?', jp:'みじん切りにしてください', reading:'미진기리니 시테 쿠다사이', choices:['みじん切りにしてください','大きく切ってください','そのままでいいです','全部捨ててください'], correct:0 },
    { q:'"잘 섞어 주세요"에 해당하는 일본어는?', jp:'よく混ぜてください', reading:'요쿠 마제테 쿠다사이', choices:['よく混ぜてください','少し混ぜてください','混ぜないでください','早く混ぜてください'], correct:0 },
    { q:'"불을 켜세요"에 해당하는 일본어는?', jp:'火をつけて', reading:'히오 츠케테', choices:['火をつけて','火を消して','火を見て','火をください'], correct:0 },
    { q:'"불을 끄세요"에 해당하는 일본어는?', jp:'火を消して', reading:'히오 케시테', choices:['火をつけて','火を見て','火を消して','火を強くして'], correct:2 },
...
},
{
  ...
  questions:[
    { q:'"같이 만들어요!"에 해당하는 일본어는?', jp:'いっしょに作りましょう！', reading:'잇쇼니 츠쿠리마쇼우', choices:['いっしょに食べましょう！','いっしょに作りましょう！','いっしょに帰りましょう！','いっしょに行きましょう！'], correct:1 },
...
},
{
  ...
  questions:[
    { q:'"자르다"를 일본어로?', jp:'切る', reading:'키루', choices:['混ぜる','切る','煮る','蒸す'], correct:1 },
    { q:'"조심하세요!"를 일본어로?', jp:'気をつけて！', reading:'키오 츠케테', choices:['気をつけて！','ありがとう！','どうぞ！','すみません！'], correct:0 },
    { q:'"잘 섞어 주세요"를 일본어로?', jp:'よく混ぜてください', reading:'요쿠 마제테 쿠다사이', choices:['よく切ってください','よく混ぜてください','よく煮てください','よく焼いてください'], correct:1 },
...
// ══════════════════════════════════════════════
{
  ...
  questions:[
    { q:'"봉투 필요 없어요"에 해당하는 일본어는?', jp:'袋はいりません', reading:'후쿠로와 이리마센', choices:['袋をください','袋はいりません','袋が好きです','袋はどこ？'], correct:1 },
    ...
    { q:'"카드로 계산할게요"에 해당하는 일본어는?', jp:'カードで払います', reading:'카아도데 하라이마스', choices:['カードで払います','現金で払います','ポイントで払います','スマホで払います'], correct:0 },
...
},
{
  ...
  questions:[
    ...
    { q:'"여기서 먹을게요"에 해당하는 일본어는?', jp:'ここで食べます', reading:'코코데 타베마스', choices:['ここで食べます','持って帰ります','テイクアウトします','外で食べます'], correct:0 },
...
},
{
  ...
  questions:[
    { q:'"봉투 필요 없어요"를 일본어로?', jp:'袋はいりません', reading:'후쿠로와 이리마센', choices:['袋をください','袋はいりません','袋が好き','袋はどこ？'], correct:1 },
...
// ══════════════════════════════════════════════
{
  ...
  questions:[
    { q:'"드라마 좋아해요?"에 해당하는 일본어는?', jp:'ドラマが好きですか？', reading:'도라마가 스키데스카', choices:['ドラマが好きですか？','ドラマを作りますか？','ドラマを見ましたか？','ドラマはどこで見ますか？'], correct:0 },
    { q:'"요즘 뭐 봐요?"에 해당하는 일본어는?', jp:'最近何を見ていますか？', reading:'사이킨 나니오 미테이마스카', choices:['最近何を見ていますか？','最近どこに行きましたか？','最近何を食べましたか？','最近何を聴いていますか？'], correct:0 },
    { q:'"재미있는 드라마예요!"에 해당하는 일본어는?', jp:'おもしろいドラマですよ！', reading:'오모시로이 도라마 데스요', choices:['おもしろいドラマですよ！','つまらないドラマです','難しいドラマです','怖いドラマです'], correct:0 },
    { q:'"한국 드라마 좋아해요"에 해당하는 일본어는?', jp:'韓国ドラマが好きです', reading:'칸코쿠 도라마가 스키데스', choices:['韓国ドラマが好きです','日本ドラマが好きです','映画が好きです','アニメが好きです'], correct:0 },
    { q:'"넷플릭스에서 보세요"에 해당하는 일본어는?', jp:'ネトフリで見てください', reading:'네토후리데 미테 쿠다사이', choices:['ネトフリで見てください','テレビで見てください','映画館で見てください','YouTubeで見てください'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"아이돌 좋아해요?"에 해당하는 일본어는?', jp:'アイドルが好きですか？', reading:'아이도루가 스키데스카', choices:['アイドルが好きですか？','アイドルになりたいですか？','アイドルを知っていますか？','アイドルに会いましたか？'], correct:0 },
    { q:'"최애가 누구예요?"에 해당하는 일본어는?', jp:'推しは誰ですか？', reading:'오시와 다레데스카', choices:['推しは誰ですか？','好きな人は誰ですか？','友達は誰ですか？','先生は誰ですか？'], correct:0 },
    { q:'"같이 들어봐요!"에 해당하는 일본어는?', jp:'いっしょに聴きましょう！', reading:'잇쇼니 키키마쇼우', choices:['いっしょに聴きましょう！','いっしょに歌いましょう！','いっしょに踊りましょう！','いっしょに見ましょう！'], correct:0 },
    { q:'"콘서트 가고 싶어요"에 해당하는 일본어는?', jp:'コンサートに行きたいです', reading:'콘사아토니 이키타이 데스', choices:['コンサートに行きたいです','コンサートに行きました','コンサートが好きです','コンサートを開きたい'], correct:0 },
    { q:'"한국 음악 좋아해요"에 해당하는 일본어는?', jp:'韓国の音楽が好きです', reading:'칸코쿠노 온가쿠가 스키데스', choices:['韓国の音楽が好きです','日本の音楽が好きです','音楽が好きです','歌が好きです'], correct:0 },
    { q:'"함께 춤춰요!"에 해당하는 일본어는?', jp:'いっしょに踊りましょう！', reading:'잇쇼니 오도리마쇼우', choices:['いっしょに踊りましょう！','いっしょに歌いましょう！','いっしょに聴きましょう！','いっしょに行きましょう！'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"한국에 온 적 있어요?"에 해당하는 일본어는?', jp:'韓国に来たことありますか？', reading:'칸코쿠니 키타코토 아리마스카', choices:['韓国に来たことありますか？','韓国に行きたいですか？','韓国が好きですか？','韓国を知っていますか？'], correct:0 },
    { q:'"서울에 가보세요"에 해당하는 일본어는?', jp:'ソウルに行ってみてください', reading:'소우루니 잇테 미테 쿠다사이', choices:['ソウルに行ってみてください','ソウルは遠いです','ソウルに住んでいます','ソウルから来ました'], correct:0 },
    { q:'"한국 음식 먹어보세요"에 해당하는 일본어는?', jp:'韓国料理を食べてみてください', reading:'칸코쿠료우리오 타베테 미테 쿠다사이', choices:['韓国料理を食べてみてください','韓国料理が好きです','韓国料理を作ります','韓国料理はどこで食べますか？'], correct:0 },
    { q:'"안내해 드릴게요!"에 해당하는 일본어는?', jp:'案内しますよ！', reading:'안나이 시마스요', choices:['案内しますよ！','案内してください','案内はいりません','案内できません'], correct:0 },
    { q:'"같이 가요!"에 해당하는 일본어는?', jp:'いっしょに行きましょう！', reading:'잇쇼니 이키마쇼우', choices:['いっしょに行きましょう！','ひとりで行きます','後で行きます','行きたくないです'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"취미가 뭐예요?"에 해당하는 일본어는?', jp:'趣味は何ですか？', reading:'슈미와 난데스카', choices:['趣味は何ですか？','仕事は何ですか？','名前は何ですか？','好きな食べ物は何ですか？'], correct:0 },
    { q:'"나는 축구를 좋아해요"에 해당하는 일본어는?', jp:'私はサッカーが好きです', reading:'와타시와 삿카아가 스키데스', choices:['私はサッカーが好きです','私はテニスが好きです','私は野球が好きです','私はバスケが好きです'], correct:0 },
    ...
    { q:'"또 같이 해요"에 해당하는 일본어는?', jp:'また一緒にやりましょう', reading:'마타 잇쇼니 야리마쇼우', choices:['また一緒にやりましょう','もうやりたくない','ひとりでやります','今日はやめます'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"아이돌 좋아해요?"를 일본어로?', jp:'アイドルが好きですか？', reading:'아이도루가 스키데스카', choices:['アイドルが好きですか？','アイドルを知っていますか？','アイドルになりますか？','アイドルに会いましたか？'], correct:0 },
    { q:'"취미가 뭐예요?"를 일본어로?', jp:'趣味は何ですか？', reading:'슈미와 난데스카', choices:['仕事は何ですか？','趣味は何ですか？','名前は何ですか？','年齢は何歳ですか？'], correct:1 },
    { q:'"한국에 온 적 있어요?"를 일본어로?', jp:'韓国に来たことありますか？', reading:'칸코쿠니 키타코토 아리마스카', choices:['韓国に行きたいですか？','韓国が好きですか？','韓国に来たことありますか？','韓国を知っていますか？'], correct:2 },
    { q:'"같이 들어봐요!"를 일본어로?', jp:'いっしょに聴きましょう！', reading:'잇쇼니 키키마쇼우', choices:['いっしょに食べましょう！','いっしょに行きましょう！','いっしょに見ましょう！','いっしょに聴きましょう！'], correct:3 },
...
// ══════════════════════════════════════════════
{
  ...
  questions:[
    { q:'"감동했어요!"에 해당하는 일본어는?', jp:'感動しました！', reading:'칸도우 시마시타', choices:['感動しました！','感謝しました！','驚きました！','笑いました！'], correct:0 },
    { q:'"마음이 따뜻해졌어요"에 해당하는 일본어는?', jp:'心が温かくなりました', reading:'코코로가 아타타카쿠 나리마시타', choices:['心が温かくなりました','心が冷たくなりました','心が痛くなりました','心が強くなりました'], correct:0 },
    { q:'"눈물 날 것 같았어요"에 해당하는 일본어는?', jp:'泣きそうになりました', reading:'나키소우니 나리마시타', choices:['泣きそうになりました','笑いそうになりました','怒りそうになりました','寝そうになりました'], correct:0 },
    { q:'"훌륭해요!"에 해당하는 일본어는?', jp:'すばらしい！', reading:'스바라시이', choices:['すばらしい！','ひどい！','普通です','よくないです'], correct:0 },
    { q:'"정말 감동이에요"에 해당하는 일본어는?', jp:'本当に感動です', reading:'혼토우니 칸도우 데스', choices:['本当に感動です','本当につまらないです','本当にわかりません','本当に驚きました'], correct:0 },
    { q:'"감동적인 이야기네요"에 해당하는 일본어는?', jp:'感動的な話ですね', reading:'칸도우테키나 하나시 데스네', choices:['感動的な話ですね','難しい話ですね','長い話ですね','怖い話ですね'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"힘들었겠네요"에 해당하는 일본어는?', jp:'大変でしたね', reading:'타이헨 데시타네', choices:['大変でしたね','楽しかったですね','よかったですね','すごかったですね'], correct:0 },
    { q:'"잘 하셨네요"에 해당하는 일본어는?', jp:'よく頑張りましたね', reading:'요쿠 간바리마시타네', choices:['よく頑張りましたね','もっと頑張ってください','頑張れなかったですね','もう頑張れません'], correct:0 },
    { q:'"힘드셨겠어요"에 해당하는 일본어는?', jp:'つらかったですね', reading:'츠라캇타 데스네', choices:['つらかったですね','楽しかったですね','よかったですね','かわいかったですね'], correct:0 },
    { q:'"함께 있어줄게요"에 해당하는 일본어는?', jp:'一緒にいますよ', reading:'잇쇼니 이마스요', choices:['一緒にいますよ','一人にしますよ','後で来ますよ','先に行きますよ'], correct:0 },
    { q:'"말해줘서 고마워요"에 해당하는 일본어는?', jp:'話してくれてありがとう', reading:'하나시테 쿠레테 아리가토우', choices:['話してくれてありがとう','聞いてくれてありがとう','来てくれてありがとう','助けてくれてありがとう'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"멋져요!"에 해당하는 일본어는?', jp:'素晴らしいですね！', reading:'스바라시이 데스네', choices:['素晴らしいですね！','ひどいですね！','普通ですね','よくないですね'], correct:0 },
    { q:'"멋있어요!"에 해당하는 일본어는?', jp:'かっこいいですね！', reading:'캇코이이 데스네', choices:['かっこいいですね！','かわいいですね！','おいしいですね！','楽しいですね！'], correct:0 },
    { q:'"정말 잘하시네요!"에 해당하는 일본어는?', jp:'とてもお上手ですね！', reading:'토테모 오죠우즈 데스네', choices:['とてもお上手ですね！','あまり上手じゃないですね','まだまだですね','難しいですね'], correct:0 },
    { q:'"웃는 얼굴이 예쁘네요!"에 해당하는 일본어는?', jp:'笑顔が素敵ですね！', reading:'에가오가 스테키 데스네', choices:['笑顔が素敵ですね！','泣き顔が素敵ですね！','眠そうですね！','怖い顔ですね！'], correct:0 },
    { q:'"존경해요!"에 해당하는 일본어는?', jp:'尊敬します！', reading:'손케이 시마스', choices:['尊敬します！','軽蔑します！','心配します！','応援します！'], correct:0 },
    { q:'"당신은 특별해요"에 해당하는 일본어는?', jp:'あなたは特別です', reading:'아나타와 토쿠베츠 데스', choices:['あなたは特別です','あなたは普通です','あなたは大変です','あなたは大丈夫です'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"괜찮아요"에 해당하는 일본어는?', jp:'大丈夫ですよ', reading:'다이죠우부 데스요', choices:['大丈夫ですよ','大変ですよ','心配ですよ','難しいですよ'], correct:0 },
    { q:'"같이 기도해요"에 해당하는 일본어는?', jp:'一緒に祈りましょう', reading:'잇쇼니 이노리마쇼우', choices:['一緒に祈りましょう','一緒に行きましょう','一緒に食べましょう','一緒に帰りましょう'], correct:0 },
    { q:'"하나님이 함께하세요"에 해당하는 일본어는?', jp:'神様が一緒にいてくれますよ', reading:'카미사마가 잇쇼니 이테 쿠레마스요', choices:['神様が一緒にいてくれますよ','神様が遠くにいますよ','神様が見ていますよ','神様が怒っていますよ'], correct:0 },
    { q:'"힘내세요!"에 해당하는 일본어는?', jp:'頑張ってください！', reading:'간밧테 쿠다사이', choices:['頑張ってください！','やめてください！','帰ってください！','静かにしてください！'], correct:0 },
    { q:'"응원하고 있어요!"에 해당하는 일본어는?', jp:'応援していますよ！', reading:'오우엔 시테이마스요', choices:['応援していますよ！','心配していますよ！','怒っていますよ！','待っていますよ！'], correct:0 }
  ]
},
{
  ...
  questions:[
    { q:'"감동했어요!"를 일본어로?', jp:'感動しました！', reading:'칸도우 시마시타', choices:['感動しました！','感謝しました！','驚きました！','笑いました！'], correct:0 },
    { q:'"힘들었겠네요"를 일본어로?', jp:'大変でしたね', reading:'타이헨 데시타네', choices:['楽しかったですね','よかったですね','大変でしたね','すごかったですね'], correct:2 },
    { q:'"멋져요!"를 일본어로?', jp:'素晴らしいですね！', reading:'스바라시이 데스네', choices:['ひどいですね！','普通ですね','素晴らしいですね！','よくないですね'], correct:2 },
    { q:'"같이 기도해요"를 일본어로?', jp:'一緒に祈りましょう', reading:'잇쇼니 이노리마쇼우', choices:['一緒に行きましょう','一緒に食べましょう','一緒に帰りましょう','一緒に祈りましょう'], correct:3 },
    { q:'"하나님이 함께하세요"를 일본어로?', jp:'神様が一緒にいてくれますよ', reading:'카미사마가 잇쇼니 이테 쿠레마스요', choices:['神様が一緒にいてくれますよ','神様が遠くにいますよ','神様が見ていますよ','神様が怒っていますよ'], correct:0 },
    { q:'"응원하고 있어요!"를 일본어로?', jp:'応援していますよ！', reading:'오우엔 시테이마스요', choices:['心配していますよ！','応援していますよ！','怒っていますよ！','待っていますよ！'], correct:1 }
  ]
}
];
